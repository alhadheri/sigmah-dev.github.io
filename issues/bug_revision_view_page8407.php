...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=685 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:06:06 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page5b17.html?return=%2Fissues%2Fbug_revision_view_page.php%3Frev_id%3D685">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:31 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
...
<tr class="spacer"><td><a name="r685"></a></td></tr>
...
<td colspan="3">On v2.0-rc3, it's impossible to do the set back a logframe model parameter to &quot;Unlimited&quot;.<br />
<br />
You can set the parameter to values like 1 or 18, but no to &quot;Unlimited&quot;.</td>
</tr>

	<tr class="spacer"><td><a name="r659"></a></td></tr>
...
<tr class="row-1">
<td class="category">Description</td>
<td colspan="3">On v2.0-rc3, it's impossible to modidfy any parameter of the logical framework of a project model. </td>
</tr>

	<tr class="spacer"><td><a name="r658"></a></td></tr>
...
<tr class="row-1">
<td class="category">Description</td>
<td colspan="3">On v2.0-rc3, it's impossible to modidfy any parameter of the logical framework of a project model. After saving, default parameters come back.</td>
</tr>
...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=685 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:06:07 GMT -->
</html>
