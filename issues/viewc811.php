...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=699&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:06:59 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_pagedd10.html?return=%2Fissues%2Fview.php%3Fid%3D699%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:32 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="#changesets">Related Changesets</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="viewc811.php?id=699&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_page2a4d.php?bug_id=699">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000699</td><td>sigmah</td><td>Offline</td><td>public</td><td>2015-04-16 13:13</td><td>2015-05-27 18:01</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>rcalabro</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>high</td><td class="category">Severity</td><td>major</td><td class="category">Reproducibility</td><td>always</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>2.0</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>2.0</td><td class="category">Fixed in Version</td><td>2.0</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000699: Offline download of unavailable files from &quot;Reports &amp; documents&quot; reported strangely online</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">On v2.0-rc1 while offline from the &quot;Reports &amp; documents&quot; sub-tab, if you try to download a file that you haven't transfered into your offline file base, you will get no reaction from Sigmah : no download will start and no message will be displayed.<br />
<br />
And actually, for each click you made on the unavailable file while offline, Sigmah will try to download the file when back online.</td></tr><tr class="row-1"><td class="category">Steps To Reproduce</td><td colspan="5">1. on a project with a big file, go offline<br />
...
<tr class="bugnote" id="c1684">
        <td class="bugnote-public">
				<span class="small">(<a href="viewb8a3.html?id=699#c1684" title="Direct link to note">0001684)</a></span><br />
...
<tr class="bugnote" id="c1737">
        <td class="bugnote-public">
				<span class="small">(<a href="viewb8a3.html?id=699#c1737" title="Direct link to note">0001737)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2015-05-27 18:01</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="row-2">
	...
	<td class="small-caption">
		Summary	</td>
	<td class="small-caption">
		Missing a message when offline file download impossible in &quot;Reports &amp; documents&quot; =&gt; Offline download of unavailable files from &quot;Reports &amp; documents&quot; reported strangely online	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2015-04-16 14:49	</td>
	...
	<td class="small-caption">
		<a href="bug_revision_view_pagec147.php?rev_id=561#r561">View Revisions</a>	</td>
</tr>
<tr class="row-2">
	<td class="small-caption">
		2015-04-16 14:49	</td>
	...
	<td class="small-caption">
		<a href="bug_revision_view_page2897.php?rev_id=563#r563">View Revisions</a>	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2015-04-27 14:52	</td>
