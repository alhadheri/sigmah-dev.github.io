...
<!-- Mirrored from www.sigmah.org/issues/plugin.php?page=Source/view&id=1830 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:03:28 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page3bef.html?return=%2Fissues%2Fplugin.php%3Fpage%3DSource%2Fview%26id%3D1830">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:28 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
...
<tr>
<td class="form-title" colspan="4">sigmah: master 453bf39f</td>
<td class="right" colspan="2">
<span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/commit/453bf39f97a0bf1251f1022f4bf2b96d1f39156c">Diff</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="plugin0da4.html?page=Source/list&amp;id=3&amp;offset=0">Back to Repository</a>&#160;]</span> </td>
<tr>
...
<td class="center">2015-12-02 18:21:01</td>
<td class="center"><a href="plugin3076.php?page=Source/view&amp;id=1831">master 2e733d85</a></td>
<td class="center">
Pending</td>
</tr>
...
<td colspan="5"><a href="view44f2.html?id=812">0000812</a>: Numerous bugs while managing existing layout groups in a project model</td>
</tr>
...
<td class="category" rowspan="5">
	Changeset</td>
<td colspan="5">Modified the layout creation and edition process (fixes <a href="view44f2.html?id=812" title="[closed] Numerous bugs while managing existing layout groups in a project model" class="resolved">0000812</a>)</td>
</tr>

<tr class="row-2">
<td class="small mono" colspan="4">mod - src/main/java/org/sigmah/client/ui/presenter/admin/models/EditLayoutGroupAdminPresenter.java</td>
...
<tr class="row-2">
<td class="small mono" colspan="4">mod - src/main/java/org/sigmah/client/ui/view/admin/models/EditLayoutGroupAdminView.java</td>
<td class="center"><span class="small-links">
...
<tr class="row-1">
<td class="small mono" colspan="4">mod - src/main/java/org/sigmah/server/service/LayoutGroupService.java</td>
<td class="center"><span class="small-links">
