...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=567&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:12:14 GMT -->
...
<head>
	...
	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Text Search" href="browser_search_plugin84ae.html?type=text" />	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Issue Id" href="browser_search_pluginb70d.html?type=id" />	<title>0000567: No more possible to move an OrgUnit - Sigmah Issue Tracker</title>
<script type="text/javascript" src="javascript/min/common.html"></script>
<script type="text/javascript">var loading_lang = "Loading...";</script><script type="text/javascript" src="javascript/min/ajax.js"></script>
<link rel="stylesheet" type="text/css" href="plugin_filea93c.css?file=Source/style.css"/></head>
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page2bb7.html?return=%2Fissues%2Fview.php%3Fid%3D567%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:40 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="viewecff.php?id=567&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_pagea813.php?bug_id=567">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000567</td><td>sigmah</td><td>Administration</td><td>public</td><td>2013-06-24 14:32</td><td>2013-07-23 11:27</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>Guerline</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>high</td><td class="category">Severity</td><td>major</td><td class="category">Reproducibility</td><td>always</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>1.2</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>1.2</td><td class="category">Fixed in Version</td><td>1.2</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000567: No more possible to move an OrgUnit</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">In version 1.2-rc3, it is no more possible to move an Orgunit once it has been created.</td></tr><tr class="row-1"><td class="category">Additional Information</td><td colspan="5">This bug has been reported on <a href="http://demo.sigmah.org/1.2-rc3/">http://demo.sigmah.org/1.2-rc3/</a> [<a href="http://demo.sigmah.org/1.2-rc3/" target="_blank">^</a>] with the demo data set.<br />
<br />
Stacktrace:<br />
<br />
2013-06-24 14:00:13,055 qtp23025815-16 DEBUG TransactionalInterceptor:57 - [invoke] Begins an entity transaction.<br />
2013-06-24 14:00:13,071 qtp23025815-16 ERROR PARSER:56 - &lt;AST&gt;:0:0: unexpected end of subtree<br />
2013-06-24 14:00:13,072 qtp23025815-16 ERROR CommandServlet:70 - Exception was thrown while executing handleCommand<br />
java.lang.IllegalArgumentException: org.hibernate.hql.ast.QuerySyntaxException: unexpected end of subtree [DELETE FROM org.sigmah.shared.domain.UserPermission WHERE database IN ()]<br />
&#160;&#160;&#160;&#160;at org.hibernate.ejb.AbstractEntityManagerImpl.throwPersistenceException(AbstractEntityManagerImpl.java:601)<br />
&#160;&#160;&#160;&#160;at org.hibernate.ejb.QueryImpl.executeUpdate(QueryImpl.java:60)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.dao.hibernate.UserPermissionHibernateDAO.deleteByProjects(UserPermissionHibernateDAO.java:52)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.policy.UserPermissionPolicy.deleteUserPermssionByOrgUnit(UserPermissionPolicy.java:147)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.endpoint.gwtrpc.handler.MoveOrgUnitHandler.execute(MoveOrgUnitHandler.java:65)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.endpoint.gwtrpc.handler.MoveOrgUnitHandler.execute(MoveOrgUnitHandler.java:18)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.endpoint.gwtrpc.CommandServlet.handleCommand(CommandServlet.java:104)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.dao.hibernate.TransactionalInterceptor.attemptInvocation(TransactionalInterceptor.java:75)<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.dao.hibernate.TransactionalInterceptor.invoke(TransactionalInterceptor.java:60)<br />
...
<tr class="bugnote" id="c1255">
        <td class="bugnote-public">
				<span class="small">(<a href="viewf6a7.html?id=567#c1255" title="Direct link to note">0001255)</a></span><br />
		<a href="view_user_page5255.html?id=9">svn_mantis-robot</a>		<span class="small">(developer)</span>
				<br />
		<span class="small">2013-07-02 10:33</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Checks if the projects list is empty before removing user permission when an OrgUnit is moved (fixes issue <a href="viewf6a7.html?id=567" title="[closed] No more possible to move an OrgUnit" class="resolved">0000567</a>)<br />
<br />
Modified : /trunk/sigmah/src/main/java/org/sigmah/server/policy/UserPermissionPolicy.java<br />
	</td>
</tr>
<tr class="spacer">
	<td colspan="2"></td>
</tr>
<tr class="bugnote" id="c1304">
        <td class="bugnote-public">
				<span class="small">(<a href="viewf6a7.html?id=567#c1304" title="Direct link to note">0001304)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2013-07-23 11:27</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Issue closed because correct behavior checked on v1.2-rc4 through integration test case <a href="http://code.google.com/p/sigma-h/wiki/TestScenario4OrgUnitManagement#OUM4">http://code.google.com/p/sigma-h/wiki/TestScenario4OrgUnitManagement#OUM4</a> [<a href="http://code.google.com/p/sigma-h/wiki/TestScenario4OrgUnitManagement#OUM4" target="_blank">^</a>]	</td>
</tr>
<tr class="spacer">
	<td colspan="2"></td>
</tr>
