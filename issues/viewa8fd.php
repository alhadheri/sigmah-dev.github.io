...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=846&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:03:12 GMT -->
...
<head>
	...
	<meta http-equiv="Expires" content="Wed, 25 Jul 2018 15:27:59 GMT" />
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_pageb405.html?return=%2Fissues%2Fview.php%3Fid%3D846%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:27 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="viewa8fd.php?id=846&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_page82be.php?bug_id=846">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000846</td><td>sigmah</td><td>Project</td><td>public</td><td>2016-02-08 17:59</td><td>2016-02-12 20:15</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>rcalabro</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>normal</td><td class="category">Severity</td><td>major</td><td class="category">Reproducibility</td><td>always</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>2.1</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>2.1</td><td class="category">Fixed in Version</td><td>2.1</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000846: Field value modification not detected properly for the computation field</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">According to its planned behavior (see <a href="view0b8f.html?id=530" title="[closed] New type of orgunit/project field: computation field" class="resolved">0000530</a>), the computation field should have its value changed dynamically when the value of one of the field part of its computation is changed.<br />
...
<br />
This bug has only been seen for computation fields in the Details sub-tab.</td></tr><tr class="row-1"><td class="category">Steps To Reproduce</td><td colspan="5">1. In a new project model, in the same group of the Details sub-tab, create two number fields and one computation field which is making the sum of the two number fields. Keep the model in draft mode.<br />
...
<tr class="bugnote" id="c1965">
        <td class="bugnote-public">
				<span class="small">(<a href="viewabb3.html?id=846#c1965" title="Direct link to note">0001965)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-02-10 12:28</span><br />
				<br /><div class="small">
				</div>
	</td>
...
<tr class="bugnote" id="c1968">
        <td class="bugnote-public">
				<span class="small">(<a href="viewabb3.html?id=846#c1968" title="Direct link to note">0001968)</a></span><br />
		<a href="view_user_pagedcfd.html?id=4">rcalabro</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-02-11 12:49</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="bugnote" id="c1969">
        <td class="bugnote-public">
				<span class="small">(<a href="viewabb3.html?id=846#c1969" title="Direct link to note">0001969)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-02-11 14:17</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="bugnote" id="c1977">
        <td class="bugnote-public">
				<span class="small">(<a href="viewabb3.html?id=846#c1977" title="Direct link to note">0001977)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-02-12 20:15</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="row-2">
	...
	<td class="small-caption">
		<a href="bug_revision_view_page2d15.php?rev_id=767#r767">View Revisions</a>	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2016-02-10 12:28	</td>
	...
	<td class="small-caption">
		<a href="bug_revision_view_page920f.php?rev_id=769#r769">View Revisions</a>	</td>
</tr>
<tr class="row-2">
	<td class="small-caption">
		2016-02-11 12:49	</td>
