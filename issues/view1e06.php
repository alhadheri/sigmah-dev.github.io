...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=780&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:04:47 GMT -->
...
<head>
	...
	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Text Search" href="browser_search_plugin84ae.html?type=text" />	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Issue Id" href="browser_search_pluginb70d.html?type=id" />	<title>0000780: Field with privacy groups invisible in Offline mode - Sigmah Issue Tracker</title>
<script type="text/javascript" src="javascript/min/common.html"></script>
<script type="text/javascript">var loading_lang = "Loading...";</script><script type="text/javascript" src="javascript/min/ajax.js"></script>
<link rel="stylesheet" type="text/css" href="plugin_filea93c.css?file=Source/style.css"/></head>
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_pagef75f.html?return=%2Fissues%2Fview.php%3Fid%3D780%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:29 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="#changesets">Related Changesets</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="view1e06.php?id=780&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_page63b6.php?bug_id=780">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000780</td><td>sigmah</td><td>Offline</td><td>public</td><td>2015-05-27 11:37</td><td>2015-06-24 09:37</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>Assistcom</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>rcalabro</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>normal</td><td class="category">Severity</td><td>major</td><td class="category">Reproducibility</td><td>always</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>2.0</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>2.0</td><td class="category">Fixed in Version</td><td>2.0</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000780: Field with privacy groups invisible in Offline mode</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">On v2.0-rc3, a user having the required privilege to see some privacy groups won't be able to see the field linked to this privacy groups in offline. He will be able to see them in online mode but not in offline mode.</td></tr><tr class="row-1"><td class="category">Steps To Reproduce</td><td colspan="5">Steps on integ with 2.0-rc3 :<br />
1. online, open project &quot;51ter&quot;<br />
=&gt; field &quot;test60&quot; is visible<br />
2. close project &quot;51ter&quot;<br />
3. switch offline<br />
4. now offline, open back &quot;51ter&quot;<br />
=&gt; field &quot;test60&quot; is no more visible</td></tr><tr class="row-2"><td class="category">Tags</td><td colspan="5">No tags attached.</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">User Report URL</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">OS</td><td colspan="5">NA</td></tr><tr class="row-1"><td class="category">Other OS</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">Browser</td><td colspan="5">NA</td></tr><tr class="row-1"><td class="category">Other browser</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">ScreenURL</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">(ActivityInfo) Noticed in revision</td><td colspan="5"></td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category"><a name="attachments" id="attachments" />Attached Files</td><td colspan="5"></td></tr><tr align="center"><td align="center" colspan="6"><table><tr class="vcenter"><td class="center"></td><td class="center"></td><td class="center"></td><td class="center"></td></tr></table></td></tr></table><br />
...
<tr class="bugnote" id="c1785">
        <td class="bugnote-public">
				<span class="small">(<a href="view4938.html?id=780#c1785" title="Direct link to note">0001785)</a></span><br />
		<a href="view_user_pagec3c9.html?id=8">anonymous</a>		<span class="small">(viewer)</span>
				<br />
		<span class="small">2015-06-16 19:00</span><br />
				<br /><div class="small">
				</div>
	</td>
...
<tr class="bugnote" id="c1854">
        <td class="bugnote-public">
				<span class="small">(<a href="view4938.html?id=780#c1854" title="Direct link to note">0001854)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2015-06-24 09:37</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="row-1">
<td class="category" width="25%" rowspan="19">
	<a name="changeset1797">sigmah: master 84ceb1b4</a>
	<br/><span class="small">Timestamp: 2015-06-16 18:26:37</span>
	<br/><span class="small">Author: daeke</span>
			<br/><span class="small">Ported: N/A</span>
		<br/><span class="small-links">
		<span class="bracket-link">[&#160;<a href="plugin7707.php?page=Source/view&amp;id=1797">Details</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/commit/84ceb1b4c881e0fd0f9818c10e74a9bb48e5aff9">Diff</a>&#160;]</span> </td>
<td colspan="3">Properly saving and restoring profile to allow display of flexible elements with privacy groups (fixes <a href="view4938.html?id=780" title="[closed] Field with privacy groups invisible in Offline mode" class="resolved">0000780</a>)</td>
</tr>
...
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/FileJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/ProfileJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/ProjectJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/ProjectReportJS.java</td>
<td class="center" width="12%"><span class="small-links">
...
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/TransfertJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/UpdateMonitoredPointsJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/UpdateRemindersJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/UserJS.java</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">mod - src/main/java/org/sigmah/offline/js/ValueJS.java</td>
<td class="center" width="12%"><span class="small-links">
...
<tr class="row-1">
	...
	<td class="small-caption">
		Summary	</td>
	<td class="small-caption">
		Disappearance of text field (number) in offline mode =&gt; Field with privacy groups invisible in Offline mode	</td>
</tr>
<tr class="row-2">
	<td class="small-caption">
		2015-05-27 13:13	</td>
	...
	<td class="small-caption">
		<a href="bug_revision_view_page838d.php?rev_id=676#r676">View Revisions</a>	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2015-05-27 13:13	</td>
	...
	<td class="small-caption">
		<a href="bug_revision_view_page28f7.php?rev_id=678#r678">View Revisions</a>	</td>
</tr>
<tr class="row-2">
	<td class="small-caption">
		2015-06-16 19:00	</td>
