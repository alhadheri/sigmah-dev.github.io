...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=569 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:07:05 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_pageaee9.html?return=%2Fissues%2Fbug_revision_view_page.php%3Frev_id%3D569">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:32 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
...
<tr class="spacer"><td><a name="r620"></a></td></tr>
...
<td colspan="3">On v2.0-rc1, when a users closes the tab of a project/orgunit or switches to another tab in the application, when he will come back to the project/orgunit tab he has quitted, the content of the project/orgunit won't be reloaded.<br />
<br />
There are many consequences of this change in v2.0-rc1 in comparison with v1.2. One of it is given in additionnal information as an example.<br />
	...
	<tr class="spacer"><td><a name="r569"></a></td></tr>

<tr class="row-2">
<td class="category">Revision</td>
<td colspan="2">2015-04-29 11:13 by osarrat</td>
<td class="center" width="5%">
</tr>
...
Only a Refresh or a closure of the session will enable him to see the phase as closed.<br />
<br />
This wasn't the case in v1.2.</td>
</tr>

	<tr class="spacer"><td><a name="r568"></a></td></tr>
...
<td colspan="3">On v2.0-rc1, if a user A modifies a project phase offline while another one closes this phase, and then user A synchronizes, he will sill see the phase as opened.<br />
<br />
Only a Refresh or a closure of the session will enable him to see the phase as closed. He can even close the project tab and reopened it : he will still see then the phase as opened.</td>
</tr>
...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=569 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:07:06 GMT -->
</html>
