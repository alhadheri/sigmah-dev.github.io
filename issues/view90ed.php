...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=682&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:05:11 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page9481.html?return=%2Fissues%2Fview.php%3Fid%3D682%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:29 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="#changesets">Related Changesets</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="view90ed.php?id=682&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_pagebcab.php?bug_id=682">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000682</td><td>sigmah</td><td>Offline</td><td>public</td><td>2015-04-13 15:22</td><td>2015-06-23 08:34</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>rcalabro</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>normal</td><td class="category">Severity</td><td>minor</td><td class="category">Reproducibility</td><td>always</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>2.0</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>2.0</td><td class="category">Fixed in Version</td><td>2.0</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000682: Bad information on project creation while offline</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">On v2.0-rc1 while offline, the &quot;New project&quot; and &quot;Draft project&quot; buttons are available.<br />
...
</td></tr><tr class="row-1"><td class="category">Additional Information</td><td colspan="5">Two solutions are possible to avoid this &quot;An unexpected error has occured&quot; error message popup:<br />
1. hide the &quot;New project&quot; and &quot;Draft project&quot; buttons when offline (preferred)<br />
2. display an information message popup &quot;Feature unavailable while offline&quot; when the user clicks on those buttons while offline.</td></tr><tr class="row-2"><td class="category">Tags</td><td colspan="5">No tags attached.</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">User Report URL</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">OS</td><td colspan="5">NA</td></tr><tr class="row-1"><td class="category">Other OS</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">Browser</td><td colspan="5">NA</td></tr><tr class="row-1"><td class="category">Other browser</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">ScreenURL</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">(ActivityInfo) Noticed in revision</td><td colspan="5"></td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category"><a name="attachments" id="attachments" />Attached Files</td><td colspan="5"><a href="file_download55f0.php?file_id=270&amp;type=bug"><img src="images/fileicons/png.gif" alt="png file icon" width="16" height="16" border="0" /></a>&#160;<a href="file_download55f0.php?file_id=270&amp;type=bug">ProjectCreationPopupAboveOfflineWarningNotAccessible.png</a> [<a href="file_download55f0.php?file_id=270&amp;type=bug" target="_blank">^</a>] (47,654 bytes) <span class="italic">2015-05-27 12:50</span>
<br /><a href="file_download55f0.php?file_id=270&amp;type=bug"><img alt="" style="border: 0; max-height:250px;" src="ProjectCreationPopupAboveOfflineWarningNotAccessibleb8ef.png?file_id=270&amp;type=bug&amp;show_inline=1&amp;file_show_inline_token=2018072571903f657d5df67ed497d9a5a077b3dfc161c54f" /></a></td></tr><tr align="center"><td align="center" colspan="6"><table><tr class="vcenter"><td class="center"></td><td class="center"></td><td class="center"></td><td class="center"></td></tr></table></td></tr></table><br />
...
<tr class="bugnote" id="c1677">
        <td class="bugnote-public">
				<span class="small">(<a href="viewd045.html?id=682#c1677" title="Direct link to note">0001677)</a></span><br />
...
<tr class="bugnote" id="c1717">
        <td class="bugnote-public">
				<span class="small">(<a href="viewd045.html?id=682#c1717" title="Direct link to note">0001717)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2015-05-27 12:50</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="bugnote" id="c1795">
        <td class="bugnote-public">
				<span class="small">(<a href="viewd045.html?id=682#c1795" title="Direct link to note">0001795)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2015-06-17 13:07</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
...
<tr class="bugnote" id="c1815">
        <td class="bugnote-public">
				<span class="small">(<a href="viewd045.html?id=682#c1815" title="Direct link to note">0001815)</a></span><br />
		<a href="view_user_pagec3c9.html?id=8">anonymous</a>		<span class="small">(viewer)</span>
				<br />
...
<tr class="bugnote" id="c1831">
        <td class="bugnote-public">
				<span class="small">(<a href="viewd045.html?id=682#c1831" title="Direct link to note">0001831)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
...
<tr class="row-2">
	...
	<td class="small-caption">
		<a href="view_user_page0b30.html?id=2">osarrat</a>	</td>
	<td class="small-caption">
		File Added: ProjectCreationPopupAboveOfflineWarningNotAccessible.png	</td>
	<td class="small-caption">
			</td>
</tr>
<tr class="row-1">
...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=682&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:05:12 GMT -->
</html>
