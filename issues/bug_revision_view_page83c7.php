...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=919 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:02:17 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page7593.html?return=%2Fissues%2Fbug_revision_view_page.php%3Frev_id%3D919">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:26 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
...
<tr class="spacer"><td><a name="r919"></a></td></tr>
...
<td colspan="3">[ERROR] {27/09/2016 23:49:37.635} [http-apr-8080-exec-3] o.s.s.handler.util.ProjectMapper - No budget ratio element was found for project #1701<br />
...
&#160;&#160;&#160;&#160;at org.sigmah.server.handler.GetProjectsFromIdHandler.execute(GetProjectsFromIdHandler.java:53) [GetProjectsFromIdHandler.class:na]</td>
</tr>

	<tr class="spacer"><td><a name="r918"></a></td></tr>
...
<td class="category">Additional Information</td>
<td colspan="3"><br />
[ERROR] {27/09/2016 23:49:37.635} [http-apr-8080-exec-3] o.s.s.handler.util.ProjectMapper - No budget ratio element was found for project #1701<br />
javax.persistence.NoResultException: No entity found for query<br />
&#160;&#160;&#160;&#160;at org.hibernate.ejb.QueryImpl.getSingleResult(QueryImpl.java:290) ~[hibernate-entitymanager-4.2.14.Final.jar:4.2.14.Final]<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.handler.util.ProjectMapper.fillBudget(ProjectMapper.java:347) [ProjectMapper.class:na]<br />
&#160;&#160;&#160;&#160;at org.sigmah.server.handler.util.ProjectMapper.map(ProjectMapper.java:248) [ProjectMapper.class:na]<br />
