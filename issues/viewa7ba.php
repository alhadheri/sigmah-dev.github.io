...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=147&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:03:14 GMT -->
...
<head>
	...
	<meta http-equiv="Expires" content="Wed, 25 Jul 2018 15:28:01 GMT" />
	<link rel="shortcut icon" href="images/favicon.html" type="image/x-icon" />
	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Text Search" href="browser_search_plugin84ae.html?type=text" />	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Issue Id" href="browser_search_pluginb70d.html?type=id" />	<title>0000147: Display reminders linked project code on dashboard - Sigmah Issue Tracker</title>
<script type="text/javascript" src="javascript/min/common.html"></script>
<script type="text/javascript">var loading_lang = "Loading...";</script><script type="text/javascript" src="javascript/min/ajax.js"></script>
<link rel="stylesheet" type="text/css" href="plugin_filea93c.css?file=Source/style.css"/></head>
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page867b.html?return=%2Fissues%2Fview.php%3Fid%3D147%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:28 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="#changesets">Related Changesets</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="viewa7ba.php?id=147&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_pagec587.php?bug_id=147">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000147</td><td>sigmah</td><td>Dashboard</td><td>public</td><td>2011-04-04 21:19</td><td>2016-02-12 20:12</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>rcalabro</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>normal</td><td class="category">Severity</td><td>feature</td><td class="category">Reproducibility</td><td>always</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>0.9</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>2.1</td><td class="category">Fixed in Version</td><td>2.1</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000147: Display reminders linked project code on dashboard</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">The linked project code+title of a reminder on the dashboard should be visible through a toolpip : &quot;Project: PROJECT_CODE - PROJECT_TITLE&quot;.<br />
More over, the title of the reminder should be transformed into an hyperlink targetting the project Management board page.</td></tr><tr class="row-1"><td class="category">Tags</td><td colspan="5">No tags attached.</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">User Report URL</td><td colspan="5"><a href="http://www.sigmah.org/node/675">http://www.sigmah.org/node/675</a> [<a href="http://www.sigmah.org/node/675" target="_blank">^</a>]</td></tr><tr class="row-1"><td class="category">OS</td><td colspan="5">NA</td></tr><tr class="row-2"><td class="category">Other OS</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">Browser</td><td colspan="5">NA</td></tr><tr class="row-2"><td class="category">Other browser</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">ScreenURL</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">(ActivityInfo) Noticed in revision</td><td colspan="5"></td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category"><a name="attachments" id="attachments" />Attached Files</td><td colspan="5"><a href="file_downloadee4b.php?file_id=131&amp;type=bug"><img src="images/fileicons/text.html" alt="patch file icon" width="16" height="16" border="0" /></a>&#160;<a href="file_downloadee4b.php?file_id=131&amp;type=bug">#147.patch</a> [<a href="file_downloadee4b.php?file_id=131&amp;type=bug" target="_blank">^</a>] (7,059 bytes) <span class="italic">2013-10-01 04:19</span><script type="text/javascript" language="JavaScript">
<!--
...
document.getElementById( span ).style.display = displayType;
 ...
 -->
 </script> <span id="hideSection_131">[<a class="small" href='#' id='attmlink_131' onclick='swap_content("hideSection_131");swap_content("showSection_131");return false;'>Show Content</a>]</span> <span style='display:none' id="showSection_131">[<a class="small" href='#' id='attmlink_131' onclick='swap_content("hideSection_131");swap_content("showSection_131");return false;'>Hide Content</a>]<pre>Index: src/main/java/org/sigmah/server/endpoint/gwtrpc/handler/GetRemindersHandler.java
===================================================================
...
<tr class="bugnote" id="c1366">
        <td class="bugnote-public">
				<span class="small">(<a href="view651a.html?id=147#c1366" title="Direct link to note">0001366)</a></span><br />
		<a href="view_user_page7d36.html?id=51">tharindum</a>		<span class="small">(developer)</span>
				<br />
		<span class="small">2013-10-01 04:20</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Please apply this patch to provide the expected feature in this issue.	</td>
</tr>
<tr class="spacer">
	<td colspan="2"></td>
</tr>
<tr class="bugnote" id="c1790">
        <td class="bugnote-public">
				<span class="small">(<a href="view651a.html?id=147#c1790" title="Direct link to note">0001790)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2015-06-17 12:45</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Status changed to &quot;feedback&quot; because feedback expected from a committer about this patch.	</td>
</tr>
<tr class="spacer">
	<td colspan="2"></td>
</tr>
<tr class="bugnote" id="c1924">
        <td class="bugnote-public">
				<span class="small">(<a href="view651a.html?id=147#c1924" title="Direct link to note">0001924)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2015-12-03 14:54</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Issue reopened because fix made in v2.0.2 not matching expected behavior.	</td>
</tr>
<tr class="spacer">
	<td colspan="2"></td>
</tr>
<tr class="bugnote" id="c1950">
        <td class="bugnote-public">
				<span class="small">(<a href="view651a.html?id=147#c1950" title="Direct link to note">0001950)</a></span><br />
...
<tr class="bugnote" id="c1976">
        <td class="bugnote-public">
				<span class="small">(<a href="view651a.html?id=147#c1976" title="Direct link to note">0001976)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-02-12 20:12</span><br />
				<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Issue closed because correct behavior checked on v2.1-rc1.	</td>
</tr>
<tr class="spacer">
	<td colspan="2"></td>
</tr>
...
<tr class="row-1">
	...
	<td class="small-caption">
		User Report URL	</td>
	<td class="small-caption">
		 =&gt; <a href="http://www.sigmah.org/node/675">http://www.sigmah.org/node/675</a> [<a href="http://www.sigmah.org/node/675" target="_blank">^</a>]	</td>
</tr>
<tr class="row-2">
	<td class="small-caption">
		2013-02-27 15:14	</td>
...
<tr class="row-2">
	...
	<td class="small-caption">
		<a href="bug_revision_view_page0793.php?rev_id=332#r332">View Revisions</a>	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2013-08-27 04:53	</td>
...
<tr class="row-2">
	...
	<td class="small-caption">
		<a href="bug_revision_view_page960f.php?rev_id=719#r719">View Revisions</a>	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2015-11-06 14:33	</td>
	...
	<td class="small-caption">
		Additional Information Updated	</td>
	<td class="small-caption">
		<a href="bug_revision_view_pageb93a.php?rev_id=720#r720">View Revisions</a>	</td>
</tr>
<tr class="row-2">
	<td class="small-caption">
		2015-12-02 19:00	</td>
