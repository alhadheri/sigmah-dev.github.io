...
INSERT INTO password_expiration_policy (id, policy_type, reference_date, organization_id) SELECT nextval('hibernate_sequence'), 'NEVER', null, MAX(id_organization) FROM organization;
