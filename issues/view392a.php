...
<!-- Mirrored from www.sigmah.org/issues/view.php?id=995&history=1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:02:19 GMT -->
...
<head>
	...
	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Text Search" href="browser_search_plugin84ae.html?type=text" />	<link rel="search" type="application/opensearchdescription+xml" title="MantisBT: Issue Id" href="browser_search_pluginb70d.html?type=id" />	<title>0000995: Easier new organisation creation with SQL function - Sigmah Issue Tracker</title>
<script type="text/javascript" src="javascript/min/common.html"></script>
<script type="text/javascript">var loading_lang = "Loading...";</script><script type="text/javascript" src="javascript/min/ajax.js"></script>
<link rel="stylesheet" type="text/css" href="plugin_filea93c.css?file=Source/style.css"/></head>
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_paged9df.html?return=%2Fissues%2Fview.php%3Fid%3D995%26history%3D1">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:26 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
<option value="1">sigmah</option>
<option value="4">Sigmah Central</option>
</select> <input type="submit" class="button-small" value="Switch" /></form><a href="200_rss_Sigmah_Issue_Tracker_-_Issuesd41d.xml?"><img src="images/rss.html" alt="RSS" style="border-style: none; margin: 5px; vertical-align: middle;" /></a></td></tr></table><table class="width100" cellspacing="0"><tr><td class="menu"><a href="my_view_page.html">My View</a> | <a href="view_all_bug_page.html">View Issues</a> | <a href="changelog_page.html">Change Log</a> | <a href="roadmap_page.html">Roadmap</a> | <a href="plugina0e2.html?page=Source/index">Repositories</a> | <a href="account_page.html">My Account</a></td><td class="menu right nowrap"><form method="post" action="http://www.sigmah.org/issues/jump_to_bug.php"><input type="text" name="bug_id" size="10" class="small" value="Issue #" onfocus="if (this.value == 'Issue #') this.value = ''" onblur="if (this.value == '') this.value = 'Issue #'" />&#160;<input type="submit" class="button-small" value="Jump" />&#160;</form></td></tr></table><br /><table class="width100" cellspacing="1"><tr><td class="form-title" colspan="3">View Issue Details&#160;<span class="small"><span class="bracket-link">[&#160;<a href="#bugnotes">Jump to Notes</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="#changesets">Related Changesets</a>&#160;]</span> </span></td><td class="center"><span class="small"></span></td><td class="right" colspan="2"><span class="small"><span class="bracket-link">[&#160;<a href="view392a.php?id=995&amp;history=1#history">Issue History</a>&#160;]</span> </span><span class="small"><span class="bracket-link">[&#160;<a href="print_bug_pagebeb0.php?bug_id=995">Print</a>&#160;]</span> </span></td></tr><tr><td class="category" width="15%">ID</td><td class="category" width="20%">Project</td><td class="category" width="15%">Category</td><td class="category" width="15%">View Status</td><td class="category" width="15%">Date Submitted</td><td class="category" width="20%">Last Update</td></tr><tr class="row-1"><td>0000995</td><td>sigmah</td><td>Tech</td><td>public</td><td>2016-10-12 10:27</td><td>2016-12-08 10:24</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">Reporter</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-1"><td class="category">Assigned To</td><td>osarrat</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Priority</td><td>normal</td><td class="category">Severity</td><td>feature</td><td class="category">Reproducibility</td><td>N/A</td></tr><tr class="row-1"><td class="category">Status</td><td bgcolor="#c9ccc4">closed</td><td class="category">Resolution</td><td>fixed</td><td colspan="2">&#160;</td></tr><tr class="row-2"><td class="category">Platform</td><td></td><td class="category">OS</td><td></td><td class="category">OS Version</td><td></td></tr><tr class="row-1"><td class="category">Product Version</td><td>2.2</td><td colspan="4">&#160;</td></tr><tr class="row-2"><td class="category">Target Version</td><td>2.2</td><td class="category">Fixed in Version</td><td>2.2</td><td colspan="2">&#160;</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category">Summary</td><td colspan="5">0000995: Easier new organisation creation with SQL function</td></tr><tr class="row-2"><td class="category">Description</td><td colspan="5">So far, creating an organisation on a Sigmah database has to be made through a search&amp;replace in a SQL script template.<br />
It will be easier and more integrated to have a SQL function part of Sigmah PostgreSQL database able to do this action. And this function will have to be updated if the process to create an organisation has to be modified.</td></tr><tr class="row-1"><td class="category">Tags</td><td colspan="5">No tags attached.</td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-2"><td class="category">User Report URL</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">OS</td><td colspan="5">NA</td></tr><tr class="row-2"><td class="category">Other OS</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">Browser</td><td colspan="5">NA</td></tr><tr class="row-2"><td class="category">Other browser</td><td colspan="5"></td></tr><tr class="row-1"><td class="category">ScreenURL</td><td colspan="5"></td></tr><tr class="row-2"><td class="category">(ActivityInfo) Noticed in revision</td><td colspan="5"></td></tr><tr class="spacer"><td colspan="6"></td></tr><tr class="row-1"><td class="category"><a name="attachments" id="attachments" />Attached Files</td><td colspan="5"></td></tr><tr align="center"><td align="center" colspan="6"><table><tr class="vcenter"><td class="center"></td><td class="center"></td><td class="center"></td><td class="center"></td></tr></table></td></tr></table><br />
...
<tr class="bugnote" id="c2139">
        <td class="bugnote-public">
				<span class="small">(<a href="view645e.html?id=995#c2139" title="Direct link to note">0002139)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-10-12 18:00</span><br />
				<br /><div class="small">
				</div>
	</td>
...
<tr class="bugnote" id="c2140">
        <td class="bugnote-public">
				<span class="small">(<a href="view645e.html?id=995#c2140" title="Direct link to note">0002140)</a></span><br />
		<a href="view_user_page0b30.html?id=2">osarrat</a>		<span class="small">(administrator)</span>
				<br />
		<span class="small">2016-10-12 18:25</span><br />
		<span class="small">edited on:&#32;2016-10-12 18:25</span><br />		<br /><div class="small">
				</div>
	</td>
	<td class="bugnote-note-public">
		Closed because correct behavior checked on v2.2-rc1.<br />
<br />
	</td>
</tr>
<tr class="spacer">
...
<td class="category" width="25%" rowspan="10">
	<a name="changeset2142">sigmah: master d8d9ccbd</a>
	<br/><span class="small">Timestamp: 2016-10-12 14:16:20</span>
	<br/><span class="small">Author: <a href="view_user_page0b30.html?id=2">osarrat</a></span>
		...
		<span class="bracket-link">[&#160;<a href="plugin03eb.php?page=Source/view&amp;id=2142">Details</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/commit/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993">Diff</a>&#160;]</span> </td>
<td colspan="3">Fixes <a href="view645e.html?id=995" title="[closed] Easier new organisation creation with SQL function" class="resolved">0000995</a><br />
<br />
...
Removed all unused SQL scripts (including former newOrganizationLaunchScript) from scripts/sql to make the place more tidy.</td>
		...
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/0-structure.postgresql.sql</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/1-actinfo-data-withoutUser.postgresql.sql</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/2-compas_quality_framework.postgresql.sql</td>
<td class="center" width="12%"><span class="small-links">
		<span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/commit/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993">Diff</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/tree/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993/scripts/sql/2-compas_quality_framework.postgresql.sql">File</a>&#160;]</span> </span></td>
</tr>
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/3-DRC-adminentities.postgresql.sql</td>
<td class="center" width="12%"><span class="small-links">
		<span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/commit/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993">Diff</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/tree/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993/scripts/sql/3-DRC-adminentities.postgresql.sql">File</a>&#160;]</span> </span></td>
</tr>
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/maj-1.2-to-trunk.sql</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/maj-2.0-to-2.1.sql</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/maj-trunk-to-2.0.sql</td>
<td class="center" width="12%"><span class="small-links">
		...
		<tr class="row-2">
<td class="small mono" colspan="2">rm - scripts/sql/newOrganizationLaunchScript.postgresql.sql</td>
<td class="center" width="12%"><span class="small-links">
		<span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/commit/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993">Diff</a>&#160;]</span> <span class="bracket-link">[&#160;<a href="http://github.com/sigmah-dev/sigmah/tree/d8d9ccbddabf3ee8c61867e6e8a8589b84e91993/scripts/sql/newOrganizationLaunchScript.postgresql.sql">File</a>&#160;]</span> </span></td>
</tr>
		<tr class="row-2">
<td class="small mono" colspan="2">add - src/main/resources/db/migration/V14__create_new_organization.sql</td>
<td class="center" width="12%"><span class="small-links">
...
<tr class="row-2">
	...
	<td class="small-caption">
		<a href="view_user_page0b30.html?id=2">osarrat</a>	</td>
	<td class="small-caption">
		Note Edited: 0002140	</td>
	<td class="small-caption">
		<a href="bug_revision_view_page8ea1.php?bugnote_id=2140#r922">View Revisions</a>	</td>
</tr>
<tr class="row-1">
	<td class="small-caption">
		2016-12-08 10:24	</td>
