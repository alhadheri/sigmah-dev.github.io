...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=767 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:03:12 GMT -->
...
<body>
<div align="left"><a href="my_view_page.html"><img border="0" alt="Sigmah Issue Tracker" src="images/sigmah-logo-Mantis.html" /></a></div><table class="hide"><tr><td class="login-info-left">Anonymous | <a href="login_page2e68.html?return=%2Fissues%2Fbug_revision_view_page.php%3Frev_id%3D767">Login</a> | <a href="signup_page.html">Signup for a new account</a></td><td class="login-info-middle"><span class="italic">2018-07-25 17:28 CEST</span></td><td class="login-info-right"><form method="post" name="form_set_project" action="http://www.sigmah.org/issues/set_project.php">Project: <select name="project_id" class="small" onchange="document.forms.form_set_project.submit();"><option value="0" selected="selected" >All Projects</option>
...
<tr class="spacer"><td><a name="r767"></a></td></tr>
...
<br />
This bug has only been seen for computation fields in the Details sub-tab.</td>
</tr>

	<tr class="spacer"><td><a name="r766"></a></td></tr>
...
<td class="category">Description</td>
<td colspan="3">According to its planned behavior (see <a href="view0b8f.html?id=530" title="[closed] New type of orgunit/project field: computation field" class="resolved">0000530</a>), the computation field should have its value changed dynamically when the value of one of the field part of its computation is changed.<br />
This is partially working (great!), but not completely. Some second modifications are not taken into account, which lead to wrong computation of values for the computation field. And in the end, is the user clicks on the &quot;Save&quot; button with a wrong dynamically computed value, this wrong value will be saved and always displayed.</td>
</tr>
...
<!-- Mirrored from www.sigmah.org/issues/bug_revision_view_page.php?rev_id=767 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 25 Jul 2018 16:03:13 GMT -->
</html>
